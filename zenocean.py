...
class R3COceanTokenizer:
    ...
    def create_data_token_by_url(self, params: OceanParameters):
        try:
            ...
            exchange_id = self.publish_dt_to_marketplace(data_token)
    ...
    def enrich_data_token_with_metadata(self, data_nft, data_token, data_url, metadata, token_address):
        dataset_files = [UrlFile(data_url)]
        ...
        dataset_asset = self.ocean.assets.create(
            ...
            provider_uri=self.ocean.config_dict["PROVIDER_URL"],
            files=dataset_files,
    ...
    def publish_dt_to_marketplace(self, data_token):
        ...
        exchange_id = self.ocean.create_fixed_rate(
            ...
            fixed_rate=self.ocean.to_wei(5),
...
#
#     data_url = "18.196.32.197:3000/get/1667815332222.json"
...
#                                    dt_name=dt_name, dt_symbol=dt_symbol, metadata=metadata)
#
